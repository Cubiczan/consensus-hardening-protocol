...
from chp.payloads import build_payload_envelope  # noqa: E402
from chp.context import ContextEngine  # noqa: E402
...
def test_triangulation_runner_and_adversary_agent_are_spawnable():
    ...
    pytest.importorskip('cme.agent', reason='AdversaryMeshAgent needs the Cognitive Mesh host')
    from chp import AdversaryMeshAgent
